...
public class Main {
    public static void main(String[] args) {
        try {
            CarDriver carDriver = new CarDriver("Ivan Ivanov", true, 10, Driver.TypeLicense.B);
            TruckDriver truckDriver = new TruckDriver("Petr Petrov", true, 6, Driver.TypeLicense.C);
            BusDriver busDriver = new BusDriver("Mixail Mihailov", true, 8, Driver.TypeLicense.D);
...
//        driverAllMethod(busDriver);
        ...
        } catch (NoLicenseException | UnsupportedOperationException e) {
            System.out.println("Enter correct license type");
